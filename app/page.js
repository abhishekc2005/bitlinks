      ...
      <section className="grid grid-cols-2 h-[50vh]">
        <div className="flex flex-col gap-4 items-center justify-center">
          ...
          <p className="px-56 text-center">
           ...
           Most of the url shorteners will track you or ask you to give your details for login
          ...
          <Link href="https://github.com/abhishekc2005"><button className='bg-purple-500 rounded-lg shadow-lg p-3 py-1 font-bold text-white'>GitHub</button></Link>
        </div>
        </div>
